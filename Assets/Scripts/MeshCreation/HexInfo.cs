...
namespace MeshCreation
{
    public static class HexInfo
    {
        ...
        private static readonly float _hexHeight = 2 * HexRadius;
        ...
        private static readonly float _hexHeightShift = HexRadius;
        private static readonly float _hexVerticalShift = 3 / 4f * _hexHeight;

        private static float HexRadius => ChunkGenerator.Instance.HexagonSize;
